...
import random
#DO THE CHANGES HERE
gmail_user = "priyangathirisha28@outlook.com"
gmail_pwd = "priyangathirisha2002"
FROM = 'priyangathirisha28@outlook.com'
TO = ['priyangathirisha28@outlook.com'] #must be a list
...
def mail():
    ...
    #DO THE CHANGES HERE
    body="This is from KEC your otp for logging in :"+str(otp_)
